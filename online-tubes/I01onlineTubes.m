...
data_root = 'G:/Action/data/ucf24';
save_root = 'G:/Action/data/output';
iteration_nums = [150000]; % you can also evaluate on multiple iterations
...
completeList = {...
    %{'ucf24','01', {'rgb'}, iteration_nums,{'iouscore'}},...
    %{'ucf24','01', {'brox'}, iteration_nums,{'iouscore'}}...
    %{'ucf24','01', {'fastOF'}, iteration_nums,{'iouscore'}}...
...
for index = 1:count-1
    ...
    if exist(opts.detDir,'dir')
        ...
        opts.annotFile = 'K:\Action\data\ucf24\ucf24\splitfiles\finalAnnots.mat';
        actionPaths(opts);
